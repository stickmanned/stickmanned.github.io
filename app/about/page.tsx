    ...
    <main className="page-shell">
      <section className="about-page-grid">
        ...
        <div>
          ...
          <p>
            Hey there. William Wen is a high school student and co-founder of Fraser Hack Club. He builds across
            hardware, web apps, games, writing, and community projects.
          </p>
          <p>
            He started coding in Grade 2 with Scratch and has since explored Python, Java, HTML, CSS, JavaScript,
      ...
      <section className="section-wrap no-pad">
        <div className="capability-grid">
          {[
            ...
            ["Pets", "A personal side with Bread the cat, guinea pigs, and goldfish from the old site."]
          ].map(([title, desc]) => (
